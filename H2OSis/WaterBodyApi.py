...
def locationApi():
    if(request.method == "POST"):
        ...
        return render_template('solutions.html',htmlString = htmlStringlist, cityString=cityString, countryString=countryString, url_str=url_str, route_urls=route_urls )
